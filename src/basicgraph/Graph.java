...
public abstract class Graph {
    ...
    public List<Integer> degreeSequence() {
        ...
        for (int i = 0; i < numVertices; i++) {
            List<Integer> aux = getNeighbors(i);
            List<Integer> aux2 = getInNeighbors(i);

            sequence.add(aux.size() + aux2.size());
        }
...
//        airportGraph.getDistance2(2).forEach(System.out::println);
